...
//       <h3 className="mb-3 text-lg font-semibold">Тестер реклами (модуль 2)</h3>
...
//             value={payload.cpm ?? 0}
//             onChange={(e) =>
//               setPayload(p => ({ ...p, cpm: e.target.value ? Number(e.target.value) : undefined }))
//             }
//           />
//         </label>
//       </div>
...
//             <div><b>ID:</b> {ad.id} | <b>CPM:</b> {ad.price}</div>
//             <div><b>Type:</b> {ad.adType} | <b>Size:</b> {ad.w}×{ad.h}</div>
//             <div><b>Geo:</b> {ad.geo ?? "-"}</div>
//             <div><b>Advertiser domains:</b> {ad.adomain.join(", ")}</div>
//             <div><p>
//     <strong>Файл креативу:</strong>{" "}
//     <a
//       href={ad.adm.match(/src="([^"]+)"/)?.[1]}
//       target="_blank"
